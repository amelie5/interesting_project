...
code='000001'
k_line_list=[]
quotes=ts.get_hist_data(code, ktype='30',start=date)
quotes= quotes.dropna()
quotes=quotes.sort_index(axis=0, by=None, ascending=True)
Close=quotes['close']
Open=quotes['open']
High=quotes['high']
Low=quotes['low']
...
for index in range(len(date_list)):
    ...
    close_price = data_per_day[index][2]
    high_price = data_per_day[index][1]
